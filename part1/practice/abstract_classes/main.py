...
class Boat(Transport):
    def start_engine(self):
        print('Катер с трудом завелся ')

    def stop_engine(self):
        print('Двигатель катера заглох с концами ')
...
class Car(Transport):
    def start_engine(self):
        print('Машина бодро завелась')

    def stop_engine(self):
        print('Машина остановилась и заглушила двигатель ')

    def move(self):
        print('Машина едет по навигатору ')
...
class Electroscooter(Transport):
    def start_engine(self):
        print('Издал звук запускающегося двигателя через динамик')

    def stop_engine(self):
        print('Издал звук заглушающегося двигателя ')
